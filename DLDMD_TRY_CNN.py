...
class DLDMD_TRY_CNN(keras.Model):
    def __init__(self, hyp_params, **kwargs):
        super(DLDMD_TRY_CNN, self).__init__(**kwargs)
        ...
        self.encoder.add(Conv1D(self.num_neurons, 3,
                               padding='same',
        ...
        self.encoder.add(Conv1D(self.latent_dim,3 ,
                                padding='same',
        ...
        self.decoder.add(Conv1D(self.num_neurons, 3,
                                padding='same',
        ...
        self.decoder.add(Conv1D(self.phys_dim, 3,
                                padding='same',
                               activation=hyp_params['ae_output_activation'],
                               kernel_initializer=hyp_params['kernel_init_dec'],
                               bias_initializer=hyp_params['bias_initializer'],
